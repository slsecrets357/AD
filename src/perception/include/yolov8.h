...
struct YoloV8Config {
    ...
    std::vector<std::string> classNames = {
        "oneway", "highwayentrance", "stopsign", "roundabout", "park", "crosswalk", "noentry", "highwayexit", "priority", "lights", "block", "pedestrian", "car"
...
public:
    ...
    void drawObjectLabels(cv::Mat& image, const std::vector<Object> &objects, const std::vector<double> &distances, unsigned int scale = 1.4);
private:
